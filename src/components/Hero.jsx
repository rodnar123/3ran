      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
          <h1 className="h1 mb-6">
            Explore Endless Cutting &nbsp;Edge Solutions&nbsp;Provided Here At
            {` `}
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            Sapos u no klia gut, displa em niupla technique wantaim niupla
            technology bilong website design. Ino moa boring stail bilong bifo
          </p>
              ...
              <div className="aspect-[33/40] rounded-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    ...
                    title="Kamapim tingting blo wok!"
                  />
                </ScrollParallax>
              </div>
            </div>
